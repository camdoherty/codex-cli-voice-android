...
remove_one "$PREFIX_DIR/bin/ccva-tmux-run"
...
remove_one "$HOME_DIR/scripts/ccva-realtime-stop"
remove_one "$HOME_DIR/scripts/codex-install-stts"
remove_one "$HOME_DIR/scripts/ccva-tmux-run"
